...
const Details = () => {
    ...
    return (
        <div>
            <div className="w-10/12 mx-auto my-12 shadow-lg  p-9">
            {/* <button onClick={()=>navigate(`${location.pathname==='/home'?'/login':-1}`)} className='flex items-center space-x-2 btn bg-custom-gradient text-white my-5'> <FaLeftLong></FaLeftLong> Back </button> */}
                <div className="flex items-center space-x-10">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className=" flex space-x-10 text-xl text-gray-600 dark:text-white font-bold"> 
